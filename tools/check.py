...
EXCEPTIONS = {
    # «Ба На Хиллс»: кадр — вырезанный монитор, пропорция 1.168 (1173x1004).
    # Высота блока штатная, под фото остаётся ~410px при ширине 1440, и
    # contain ограничен высотой: ширина монитора = 410 * 1.168 = 479px, это
    # 33% секции. Довести до эталонных 62-74% можно только подняв высоту
    ...
    # Замеры: 33% на 1440, 39% на 1920, 41% на 2880 — цель 37 с допуском 12%.
    ("Ба На Хиллс", "media_w_pct"): ((37, 0.12), "вырезка 1.168 ограничена высотой полосы"),
}
