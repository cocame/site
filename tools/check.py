...
EXCEPTIONS = {
    # «Ба На Хиллс»: кадр — вырезанный монитор, пропорция 1.201 (1172x976).
    # Высота блока штатная, под фото остаётся ~410px при ширине 1440, и
    # contain ограничен высотой: ширина монитора = 410 * 1.201 = 492px, это
    # 34% секции. Довести до эталонных 62-74% можно только подняв высоту
    ...
    # Замеры: 34% на 1440, 40% на 1920, 42% на 2880 — цель 38 с допуском 12%.
    ("Ба На Хиллс", "media_w_pct"): ((38, 0.12), "вырезка 1.201 ограничена высотой полосы"),
}
